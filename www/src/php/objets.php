...
<?php
    foreach ($result as $key => $array) {
        ...
        if(file_exists("./src/images/photos_objets/".$_SESSION['username'].'/'.$array['nomObjet'].'_'.$array['idObjet'].".PNG")){
            echo '<img class="logo" src="./src/images/photos_objets/'.$_SESSION['username'].'/'.$array['nomObjet'].'_'.$array['idObjet'].'.PNG" alt="logo' . $array['nomObjet'] . '"> <br/>';
        }elseif (file_exists("./src/images/photos_objets/".$_SESSION['username'].'/'.$array['nomObjet'].'_'.$array['idObjet'].".png")) {
            echo '<img class="logo" src="./src/images/photos_objets/'.$_SESSION['username'].'/'.$array['nomObjet'].'_'.$array['idObjet'].'.png" alt="logo' . $array['nomObjet'] . '"> <br/>';
        }elseif (file_exists("./src/images/photos_objets/".$_SESSION['username'].'/'.$array['nomObjet'].'_'.$array['idObjet'].".jpg")) {
            echo '<img class="logo" src="./src/images/photos_objets/'.$_SESSION['username'].'/'.$array['nomObjet'].'_'.$array['idObjet'].'.jpg" alt="logo' . $array['nomObjet'] . '"> <br/>';
        }elseif (file_exists("./src/images/photos_objets/".$_SESSION['username'].'/'.$array['nomObjet'].'_'.$array['idObjet'].".JPG")) {
            echo '<img class="logo" src="./src/images/photos_objets/'.$_SESSION['username'].'/'.$array['nomObjet'].'_'.$array['idObjet'].'.JPG" alt="logo' . $array['nomObjet'] . '"> <br/>';
        }else{
