<h1 class="hr"><?php echo $result[0]['nomObjet']; ?> </h1>
<div id="detailsContainer">
<h1>
    <?php echo $result[0]['nomObjet']; ?>
</h1>

<?php
    if(file_exists("./src/images/photos_objets/".$result[0]['nomObjet'].'_'.$result[0]['idObjet'].".PNG")){
        echo '<img class="logo" src="./src/images/photos_objets/'.$result[0]['nomObjet'].'_'.$result[0]['idObjet'].'.PNG" alt="logo' . $result[0]['nomObjet'] . '"> <br/>';
        ...
        echo '<img class="logo" src="./src/images/photos_objets/'.$result[0]['nomObjet'].'_'.$result[0]['idObjet'].'.jpg" alt="logo' . $result[0]['nomObjet'] . '"> <br/>';
    }elseif (file_exists("./src/images/photos_objets/".$result[0]['nomObjet'].'_'.$result[0]['idObjet'].".JPG")) {
        echo '<img class="logo" src="./src/images/photos_objets/'.$result[0]['nomObjet'].'_'.$result[0]['idObjet'].'.JPG" alt="logo' . $result[0]['nomObjet'] . '"> <br/>';
    }else{
